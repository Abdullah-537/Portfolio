...
export default function Footer() {
  return (
    <footer className="relative z-20 py-12 px-[5%] md:px-[10%] bg-[#050a14] border-t border-white/10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <h2 className="text-2xl font-bold text-white tracking-tight">Abdullah Shabbir.</h2>
          <p className="text-gray-500 mt-2 text-sm">Building elegant, scalable solutions.</p>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="https://wa.me/923327660123" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#ff9d00] transition-colors p-2 hover:bg-white/5 rounded-full">
            <WhatsAppIcon className="w-5 h-5" />
          </a>
        </div>
      </div>
      <div className="text-center mt-12 text-sm text-gray-600">
        &copy; {new Date().getFullYear()} Abdullah Shabbir. All rights reserved.
      </div>
    </footer>
  );
}
